...
# --patch_merge --merge_method $merge_method --merge_group_num $merge_group_num --merge_group_size $merge_group_size_1 $merge_group_size_2 --distance $distance --token_pos $token_pos_1 $token_pos_2
# done
# done
# done